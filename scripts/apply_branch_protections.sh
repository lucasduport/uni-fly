...
REQUIRED_CHECKS_MAIN='["Lint (ruff)","Type check (mypy)","Test (pytest) (3.12)","Test (pytest) (3.13)","pre-commit","Build site"]'
REQUIRED_CHECKS_DEV='["Lint (ruff)","Type check (mypy)","Test (pytest) (3.12)","Test (pytest) (3.13)","pre-commit","Build site"]'
